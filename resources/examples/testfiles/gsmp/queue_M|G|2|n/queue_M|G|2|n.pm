// This is a model of M/G/2/n queue taken from http://www.fi.muni.cz/~xuhrik/
// The inter-arrival time is specified by exponential events autogenerated from the old-fashioned CTMC transitions.
// The service times of station 1 and station 2 are specified by service1 and service2, respectively.
...
event service1 = dirac(1.0);   //time required to serve arrivals in station 1
event service2 = dirac(1.0);   //time required to serve arrivals in station 2
